...
setup:	enable
	VAULT_ADDR=http://127.0.0.1:8200 vault write datadog/config  api_key=${DATADOG_API_KEY} app_key=${DATADOG_APP_KEY} api_key_id=${DATADOG_API_KEY_ID} app_key_id=${DATADOG_APP_KEY_ID} site=${DATADOG_SITE}
